...
export const TimelineCard = ({ deal, isOverlay }: TimelineCardProps) => {
  ...
  return (
    ...
    >
      <Card className="flex cursor-grab flex-col gap-1.5 rounded-xl border border-border/50 bg-card p-3 shadow-sm transition-all hover:border-border/80 hover:shadow-md active:cursor-grabbing">
